...
def handler(event, context):
    ...
    region = 'us-east-2'
    statusCode = 200
    output_filename=sourceS3Key.split("/")[-1]
    ...
    try:
        ...
        transcodedPath = "transcodedVideo/"+media_id
        outputPath = sourceS3Key.replace("Video",transcodedPath)
        S3KeyHLS = sourceS3Key
        jobSettings['OutputGroups'][0]['OutputGroupSettings']['HlsGroupSettings']['Destination'] \
            = destinationS3 + '/' + outputPath
